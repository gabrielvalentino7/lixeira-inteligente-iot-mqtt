...
Quanto maior a distância medida, menor é o nível de ocupação da lixeira. Quanto menor a distância medida, maior é o nível de ocupação.
...
## Sensor previsto para aplicação física
